...
<div class="grid grid-cols-1 md:grid-cols-2 md:gap-14 lg:gap-20 pt-8 sm:pt-10 relative text-base">
    <div class={"flex flex-col gap-8 md:gap-10 " + (index % 2 === 1 ? " md:order-2": " ")}>
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex gap-2 items-center ">
                <div class="grid place-items-center px-1.5 text-xs sm:text-sm aspect-square rounded-full border-[1.5px] bg-white border-solid border-green-300  ">
                    <i class="fa-bolt fa-solid text-green-400 "></i>
                </div>
                <p>{listItem}</p>
            </div>
            {/each}
